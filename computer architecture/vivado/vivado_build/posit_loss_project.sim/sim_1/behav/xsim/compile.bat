...
REM
REM Generated by Vivado on Tue Apr 21 00:22:20 +0530 2026
...
echo "xvlog --incr --relax -prj tb_all_losses_vlog.prj"
call xvlog  --incr --relax -prj tb_all_losses_vlog.prj -log xvlog.log
